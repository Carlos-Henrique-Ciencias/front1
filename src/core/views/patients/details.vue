  ...
  <div class="flex gap-4 flex-col">
    ...
    <div class="grid gap-4 grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
      <Card class="p-4 rounded-sm w-full">
        ...
        <button class="button" @click="navigateTo(`/patients/${customerId}/antecedentes-clinicos`)">Ver Detalhes</button>
      </Card>
      <Card class="p-4 rounded-sm w-full">
        <span class="font-bold">Antec. cirúrgicos</span><br>
        <span class="text-sm">Laparopsia para remoção de endometriose, cesária</span><br>
        <button class="button" @click="navigateTo(`/patients/${customerId}/antecedentes-cirurgicos`)">Ver Detalhes</button>
      </Card>
      <Card class="p-4 rounded-sm w-full">
        <span class="font-bold">Antec. Familiares</span><br>
        <span class="text-sm">DMA, CA de mama</span><br>
        <button class="button" @click="navigateTo(`/patients/${customerId}/antecedentes-familiares`)">Ver Detalhes</button>
      </Card>
      <Card class="p-4 rounded-sm w-full">
        <span class="font-bold">Hábitos</span><br>
        <span class="text-sm">Caminhada de 30min 3x semana</span><br>
        <button class="button" @click="navigateTo(`/patients/${customerId}/habitos`)">Ver Detalhes</button>
      </Card>
    </div>
    <div>
    ...
    <!-- Remover a seção de navegação duplicada -->
    <!-- Seção de navegação existente -->
